...
| 이준석         | - |
| 이수연         | - |
| 정지영         | 리액트는 배워도 낯설기만 하고 사실 아직도 낯설지만, 좋은 팀원분들을 만나 무사히 마칠 수 있어서 다행이란 생각이 들었습니다.<br/>힘들었지만 유쾌하고 성격 좋은 팀원분들이 있어서 재밌게 진행했고, 끝까지 프로젝트를 마칠 수 있게 해줘서 감사하다는 말을 전달하고 싶습니다.싶습니다.<br/>개인적으로는 스스로에 대한 실력에 부족함을 많음을 깨달았고, 컴포넌트 간의 상태 관리에 관한 공부가 절실히 필요하다고 느꼈습니다. <br/>그 외에도 성능 최적화를 위해 이미지 파일 형식을 png이 아닌 WEBP로 올리는 게 적합하다는 점, 텍스트와 배경간의 명도 대비도 중요함을 많이 느꼈습니다.|
