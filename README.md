...
4. [📖 기술스택](#4--기술스택)
5. [🥁 팀내 규칙](#5--팀내-규칙)
6. [📂 파일 디렉토리](#8--추가로-구현하고-싶은-기능)
7. [🖥️ 코드리뷰 with 구현 페이지(고정형)](#6-%EF%B8%8F-코드리뷰-with-구현-페이지고정형)
8. [💎 성능검사](#7--성능검사)
9. [🔎 추가로 구현하고 싶은 기능](#8--추가로-구현하고-싶은-기능)
10.[💫 한 줄 소감](#8--추가로-구현하고-싶은-기능)
...
| 이준석         | - |
| 이수연         | - |
| 정지영         | 리액트는 배워도 낯설기만 했는데, 좋은 팀원 분들을 만나 무사히 마칠 수 있어서 다행이란 생각이 들었습니다.<br/>힘들었지만 유쾌하고 성격 좋은 팀원 분들이 있어서 재밌게 진행했고, 너무 감사하다는 말을 전달하고 싶습니다. |
